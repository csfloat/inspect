...
class Bot extends EventEmitter {
  ...
  constructor(settings, proxy, steamID, refreshToken) {
    super();
  ...
  logIn() {
    ...
    winston.info(`Logging in ${this.steamID}`);
    ...
    winston.debug(`${this.steamID} About to connect`);

    return this.steamClient.logOn(this.loginData);
  }
