...
class Postgres {
  ...
  static buildQuery(itemCount) {
    ...
    for (let c = 0; c < itemCount; c++) {
      values.push(
        `($${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}, $${i++}::jsonb, now(), $${i++}, NULL, $${i++})`,
      );
    }

    return `INSERT INTO raw_assets (ms, a, d, paintseed, paintwear, defindex, paintindex, stattrak, souvenir, props, stickers, updated, rarity, floatid, price)
