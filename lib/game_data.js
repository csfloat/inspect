...
class GameData {
    ...
    */
    addAdditionalItemProperties(iteminfo) {
        ...
        for(var i=0;i<iteminfo.stickers.length;i++){
            if (iteminfo.stickers[i].sticker_id in this.items_game['items_game']['sticker_kits']) {
                iteminfo.stickers[i]['codename'] = this.items_game['items_game']['sticker_kits'][iteminfo.stickers[i].sticker_id]['name'];
                iteminfo.stickers[i]['name'] = this.csgo_english['lang']['Tokens'][this.items_game['items_game']['sticker_kits'][iteminfo.stickers[i].sticker_id]['item_name'].replace('#', '')];
            }
        }
